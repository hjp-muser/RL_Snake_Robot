...
def get_target_updates(_vars, target_vars, tau, verbose=0):
    ...
    :param verbose: (int) the verbosity level: 0 none, 1 training information, 2 tensorflow1 debug
...
def get_perturbable_vars(scope):
    ...
    :param scope: (str) tensorflow1 scope of the variables
    :return: ([tf.Variables])
    """
...
class DDPG(OffPolicyRLModel):
    ...
    :param seed: (int) Seed for the pseudo-random generators (python, numpy, tensorflow1).
