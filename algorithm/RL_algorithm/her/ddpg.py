...
from algorithm.RL_algorithm.her.replay_buffer import ReplayBuffer
...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        DEMO_BUFFER = ReplayBuffer(buffer_shapes, self.buffer_size, self.T, self.sample_transitions)
    ...
    def store_episode(self, episode_batch, update_stats=True):
        ...
        if update_stats:
            ...
            num_normalizing_transitions = episode_batch['u'].shape[0]
